...
class EditMe extends Component {
  ...
  render() {
    ...
    return (
      ...
      <h2>Your Nottingham Persona</h2>
      <p>You are a Comp Sci Notable at Nottingham, choose your individual and their location! </p>
        <h3>Select your individual</h3>
        ...
        <h3 className="select-territory">Select your location</h3>
